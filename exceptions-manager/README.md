...
# Exception manager
This maven project module, written in Java, can be used for converting a java exception stack trace into a printable string. This is useful for general warnings and diagnostics.
