...
# Progress bar
This Maven project module, written in Java, can be used for showing the progress bars GUI.
In particular, the library offers single and multiple progress bars (organised in a table).
