...
/**
 * Main menu of the catalogue browser. The menu bar is subdivided in different
 * sections and allows to perform several editing and non editing operations on
 * the catalogue.
 * 
 * @author shahaal
 * @author avonva
...
public class MainMenu extends Observable implements Observer {
	...
	/**
	 * Update the menu that something has changed in the sub menus
	 * 
	...
	/**
	 * Listener to observe the dcf menu item
	 * 
	 * @param loginListener
	 */
